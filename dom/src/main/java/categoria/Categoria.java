...
/**
 * 
 * Entidad que representa la Categoria del Vehiculo. En ella se encuentran
 * propiedades tales como Caja, Traccion, Cantidad de Puertas y Precio.
 * 
 */
@javax.jdo.annotations.PersistenceCapable(identityType = IdentityType.DATASTORE)
@javax.jdo.annotations.DatastoreIdentity(strategy = javax.jdo.annotations.IdGeneratorStrategy.IDENTITY)
@javax.jdo.annotations.Queries({ @javax.jdo.annotations.Query(name = "listado_categoria", language = "JDQL", value = "SELECT FROM dom.categoria.Categoria WHERE activo== :true ") })
...
public class Categoria {
	...
	/**
	 * Titulo identificatorio en la UI. Retorna el nombre de la Categoria.
	 * 
	 * @return String
	 */
	public String title() {
	...
	/**
	 * Accion que borra la Categoria especificado. Provisto por el Framework.
	 */
	@Named("Borrar")
	public void remove() {
		setActivo(false);
