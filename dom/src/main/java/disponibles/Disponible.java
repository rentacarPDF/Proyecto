...
/**
 * 
 * Sirve para mostrar el Estado de alquiler de los vehiculos
 * en una fecha determinada o un rango de fechas, y que el usuario
 * pueda seleccionar el vehiculo que desee alquilar.
 * Los objetos de esta clase se persisten y luego se borran al momento de realizar el alquiler. 
 * 
 * Por lo tanto no es necesario que esta Entidad se persista ya que esta informacion ser&aacute; almacenada
 * en la BD una vez que se efectue el alquiler.
 */
...
@javax.jdo.annotations.Queries( {
    @javax.jdo.annotations.Query(
            ...
            value="SELECT FROM disponibles.Disponible")
})
...
public class Disponible {
    ...
    /**
     * Propiedad provista por el Framework, retorna un boolean si está o no seleccionada.
     * Graficamente se representa con un checkbox
     * 
     * @return boolean
     */
    @Named("Seleccionada")
    ...
    /**
     * Accion que provee el Framework para seleccionar objetos de una lista 
     * a través de un checkbox.
     * 
     * Se utiliza para seleccionar el/los vehiculo/s disponibles que 
     * selecciona el cliente para alquilar.
     * 
     * @return Disponible
     */
    @Named("Seleccionar")
    ...
    /**
	 * Metodo provisto por el framework que deshabilita 
	 * la opcion de poder editar la reserva.
	 * 
